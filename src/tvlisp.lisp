...
;;; NB: the framework-agnostic logic (sexp/git/grep/profile/http/CLHS + the
;;; TVISION-TVLISP package) now lives in the `tvlisp-logic` system
;;; (logic/package.lisp + logic/app-logic.lisp); this file is the classic UI.
