...
(declaim (special +repl-hist-symbols+))   ; defined in logic/repl-backend.lisp (tvlisp-logic)
...
;;; ===========================================================================
;;; Backend (completion + evaluation) moved to logic/repl-backend.lisp
;;; (system tvlisp-logic); this file is only the TReplView on top of it.
;;; ===========================================================================
...
;;; The OBJECT->OUTLINE inspector model moved to logic/inspect.lisp
;;; (system tvlisp-logic); the TInspectorWindow that displays it is below.
