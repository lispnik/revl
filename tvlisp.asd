;;;; tvlisp.asd --- a SLIME-class Lisp IDE on the revision CLOS-native framework.
;;;;
;;;; tvlisp is built on `revision' (../tvision/revision), the CLOS-native framework, plus
...
(asdf:defsystem "tvlisp"
  :description "tvlisp: a SLIME-class Common Lisp IDE on the revision framework."
  :author "Matthew Kennedy"
  :license "MIT"
  :version "0.1.0"
  :depends-on ("revision" "tvlisp-logic")
  :serial t
